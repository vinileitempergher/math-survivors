...
var quiz_questions = {
	...
	{"question": "Fácil – Porcentagem: 50% de 90 = ?", "answer": 45, "options": [40, 45, 50, 55]},
	{"question": "Fácil – Porcentagem: 1% de 500 = ?", "answer": 5, "options": [0.5, 5, 50, 100]},
	...
	{"question": "Fácil – Notação científica: 1 × 10^3 = ?", "answer": 1000, "options": [10, 100, 1000, 10000]},
	{"question": "Fácil – Notação científica: 2,5 × 10^2 = ?", "answer": 250, "options": [25, 250, 2500, 0.25]},
	# Potenciação
	{"question": "Fácil – Potenciação: 2^3 = ?", "answer": 8, "options": [6, 8, 9, 12]},
	{"question": "Fácil – Potenciação: 5^2 = ?", "answer": 25, "options": [20, 24, 25, 30]},
	{"question": "Fácil – Potenciação: 10^3 = ?", "answer": 1000, "options": [30, 100, 1000, 10000]},
	{"question": "Fácil – Potenciação: 7^0 = ?", "answer": 1, "options": [0, 1, 7, 10]},
	{"question": "Fácil – Potenciação: (-2)^2 = ?", "answer": 4, "options": [-4, 2, 4, -2]},
	# Raiz
	{"question": "Fácil – Raiz quadrada: √81 = ?", "answer": 9, "options": [7, 8, 9, 10]},
	{"question": "Fácil – Raiz quadrada: √49 = ?", "answer": 7, "options": [5, 6, 7, 8]},
	{"question": "Fácil – Raiz quadrada: √100 = ?", "answer": 10, "options": [1, 10, 20, 100]},
	{"question": "Fácil – Raiz quadrada: √1 = ?", "answer": 1, "options": [0, 0.5, 1, 10]},
	# Área e perímetro
	...
	{"question": "Fácil – Área: quadrado de lado 4 = ?", "answer": 16, "options": [8, 12, 16, 20]},
	{"question": "Fácil – Perímetro: retângulo 5 × 3 = ?", "answer": 16, "options": [15, 16, 18, 20]},
	# Números inteiros
	{"question": "Fácil – Inteiros: (-7) + 12 = ?", "answer": 5, "options": [3, 4, 5, 6]},
	{"question": "Fácil – Inteiros: 10 - 15 = ?", "answer": -5, "options": [5, -5, -10, -15]},
	{"question": "Fácil – Inteiros: (-3) × 4 = ?", "answer": -12, "options": [12, -1, -7, -12]},
	{"question": "Fácil – Inteiros: (-10) ÷ (-2) = ?", "answer": 5, "options": [5, -5, 8, -8]},
	# Expressões Algébricas (Valor Numérico)
	{"question": "Fácil – Álgebra: Se x = 2, qual o valor de x + 5?", "answer": 7, "options": [5, 6, 7, 8]},
	{"question": "Fácil – Álgebra: Se y = 3, qual o valor de 2y?", "answer": 6, "options": [3, 5, 6, 9]},
	{"question": "Fácil – Álgebra: Se a = 1, qual o valor de a - 10?", "answer": -9, "options": [9, -9, 10, -11]},
	# Equações de 1º Grau (Simples)
	{"question": "Fácil – Equação: x + 2 = 5, x = ?", "answer": 3, "options": [1, 2, 3, 4]},
	{"question": "Fácil – Equação: y - 1 = 7, y = ?", "answer": 8, "options": [5, 6, 7, 8]}
	],
	"medium": [
	# Porcentagem
	...
	{"question": "Médio – Porcentagem: 120 é 20% de qual número?", "answer": 600, "options": [24, 240, 600, 1200]},
	{"question": "Médio – Porcentagem: Um produto de R$80 teve 10% de desconto. Qual o novo preço?", "answer": 72, "options": [8, 70, 72, 79]},
	...
	{"question": "Médio – Notação científica: Escreva 45000 em notação científica.", "answer": "4,5 × 10^4", "options": ["45 × 10^3", "4,5 × 10^4", "4,5 × 10^3", "0,45 × 10^5"]},
	{"question": "Médio – Notação científica: (2 × 10^2) × (3 × 10^1) = ?", "answer": 6000, "options": [60, 600, 6000, 60000]},
	# Potenciação
	...
	{"question": "Médio – Potenciação: (-3)^3 = ?", "answer": -27, "options": [27, -27, 9, -9]},
	{"question": "Médio – Potenciação: 5^(-1) = ?", "answer": 0.2, "options": [-5, 5, 0.5, 0.2]},
	{"question": "Médio – Potenciação: (2^2)^3 = ?", "answer": 64, "options": [12, 16, 32, 64]},
	# Raiz
	{"question": "Médio – Raiz quadrada: √225 = ?", "answer": 15, "options": [13, 14, 15, 16]},
	{"question": "Médio – Raiz cúbica: ³√8 = ?", "answer": 2, "options": [1, 2, 3, 4]},
	{"question": "Médio – Raiz cúbica: ³√27 = ?", "answer": 3, "options": [3, 6, 9, 1.8]},
	# Área e perímetro
	...
	{"question": "Médio – Área: círculo de raio 5 (use π ≈ 3) = ?", "answer": 75, "options": [15, 30, 75, 150]},
	{"question": "Médio – Perímetro: circunferência de raio 10 (use π ≈ 3,14) = ?", "answer": 62.8, "options": [31.4, 62.8, 100, 314]},
	# Números inteiros
	{"question": "Médio – Inteiros: (-12) - (-7) = ?", "answer": -5, "options": [-19, -5, 5, 7]},
	{"question": "Médio – Inteiros: (-5) × (-3) + 4 = ?", "answer": 19, "options": [11, 19, -11, -19]},
	# Expressões Algébricas (Valor Numérico)
	{"question": "Médio – Álgebra: Se x = 2 e y = 3, qual o valor de 3x + y?", "answer": 9, "options": [8, 9, 10, 11]},
	{"question": "Médio – Álgebra: Se a = 5 e b = -1, qual o valor de a × b?", "answer": -5, "options": [5, -5, 4, -4]},
	# Equações de 1º Grau
	{"question": "Médio – Equação: 2x + 1 = 11, x = ?", "answer": 5, "options": [4, 5, 6, 10]},
	{"question": "Médio – Equação: 3y - 5 = 10, y = ?", "answer": 5, "options": [3, 4, 5, 6]},
	# Estatística (Média)
	{"question": "Médio – Estatística: Qual a média de 5, 10 e 15?", "answer": 10, "options": [5, 10, 15, 30]},
	{"question": "Médio – Estatística: Qual a mediana de 1, 2, 5, 7, 10?", "answer": 5, "options": [1, 2, 5, 7]},
	{"question": "Médio – Estatística: Qual a moda de 2, 3, 3, 5, 7?", "answer": 3, "options": [2, 3, 5, 7]}
	],
	"hard": [
	# Porcentagem
	...
	{"question": "Difícil – Porcentagem: Um produto foi de R$150 para R$180. Qual foi o aumento percentual?", "answer": "20%", "options": ["15%", "20%", "25%", "30%"]},
	{"question": "Difícil – Porcentagem: Paguei R$120 por um item com 20% de desconto. Qual era o preço original?", "answer": 150, "options": [140, 144, 150, 160]},
	# Notação científica
	...
	{"question": "Difícil – Notação científica: (8 × 10^5) ÷ (2 × 10^2) = ?", "answer": "4 × 10^3", "options": ["4 × 10^2", "4 × 10^3", "4 × 10^4", "4 × 10^7"]},
	{"question": "Difícil – Notação científica: 0,00052 em notação científica = ?", "answer": "5,2 × 10^-4", "options": ["5,2 × 10^4", "5,2 × 10^-3", "5,2 × 10^-4", "52 × 10^-5"]},
	# Potenciação
	...
	{"question": "Difícil – Potenciação: 10^3 ÷ 10^5 = ?", "answer": 0.01, "options": [100, 0.01, -100, 0.1]},
	{"question": "Difícil – Potenciação: (2/3)^(-2) = ?", "answer": 2.25, "options": ["4/9", "9/4", "6/4", "4/6"]},
	# Raiz
	{"question": "Difícil – Raiz: √144 + √81 = ?", "answer": 21, "options": [20, 21, 22, 24]},
	{"question": "Difícil – Raiz: √(7² + 24²) = ?", "answer": 25, "options": [31, 25, 49, 576]},
	# Área e perímetro
	...
	{"question": "Difícil – Área: trapézio (B=10, b=6, h=5) = ?", "answer": 40, "options": [35, 40, 45, 50]},
	{"question": "Difícil – Área: losango (D=8, d=6) = ?", "answer": 24, "options": [14, 24, 28, 48]},
	# Números inteiros
	{"question": "Difícil – Inteiros: |−18| − |−7| = ?", "answer": 11, "options": [9, 10, 11, 12]},
	{"question": "Difícil – Inteiros: (-2)^3 + 5 × 4 = ?", "answer": 12, "options": [-8, 12, 28, -28]},
	# Expressões Algébricas (Produtos Notáveis)
	{"question": "Difícil – Álgebra: (x + 3)² = ?", "answer": "x² + 6x + 9", "options": ["x² + 9", "x² + 3x + 9", "x² + 6x + 9", "x + 6"]},
	{"question": "Difícil – Álgebra: (y - 5)(y + 5) = ?", "answer": "y² - 25", "options": ["y² + 25", "y² - 10y + 25", "y² - 25", "y² - 10"]},
	# Equações de 1º Grau
	{"question": "Difícil – Equação: 5(x - 1) = 2x + 4, x = ?", "answer": 3, "options": [1, 2, 3, 4]},
	{"question": "Difícil – Equação: x/2 + 3 = 7, x = ?", "answer": 8, "options": [4, 6, 8, 10]},
	# Sistemas de Equações
	{"question": "Difícil – Sistema: Se x+y=10 e x-y=4, qual o valor de x?", "answer": 7, "options": [5, 6, 7, 8]},
	{"question": "Difícil – Sistema: Se x+y=10 e x-y=4, qual o valor de y?", "answer": 3, "options": [2, 3, 4, 5]},
	# Estatística (Média, Moda, Mediana)
	{"question": "Difícil – Estatística: Média das notas 8, 9, 7, 6 = ?", "answer": 7.5, "options": [7, 7.5, 8, 8.5]},
	{"question": "Difícil – Estatística: Mediana de 8, 10, 4, 12 = ?", "answer": 9, "options": [8, 9, 10, 11]},
	# Geometria (Polígonos)
	{"question": "Difícil – Geometria: Soma dos ângulos internos de um pentágono = ?", "answer": 540, "options": [180, 360, 540, 720]},
	{"question": "Difícil – Geometria: Quantas diagonais tem um hexágono?", "answer": 9, "options": [6, 8, 9, 12]}
	]
}
